...
image_binary = image_binary + (size_height//number_of_colors)*(colors.medium_violet_red_pix * size_width + bmp.pad_byte * 3)
image_binary = image_binary + (size_height//number_of_colors)*(colors.pale_turquoise_pix * size_width + bmp.pad_byte * 3)
image_binary = image_binary + (size_height//number_of_colors)*(colors.green_yellow_pix * size_width + bmp.pad_byte * 3)
image_binary = image_binary + (size_height//number_of_colors)*(colors.light_cyan_pix * size_width + bmp.pad_byte * 3)
